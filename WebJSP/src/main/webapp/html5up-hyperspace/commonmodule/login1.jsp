...
<%
	...
	//1. 한글처리
		request.setCharacterEncoding("UTF-8");//get은 괜찮으면 post 에서 한글 처리를 해줘야한다.
	//2. 데이터 받기
		String id = request.getParameter("id");
	//3. 로직처리(비지니스 업무) >> DB작업 >> 암호화작업 >> 개발자 마음
	
	//1. http://localhost:8090/WebJSP/Ex04_login.html 요청 보내요.
	//2. 서버는 요청을 받고 ... WAS 가 Web Server 처리 >> Ex04_login.jtml client 전달
	...
	//4.2 client 정보 (IP, 브라우저 정보, 입력값, 전송방식)
...
<body>
	...
	context root(http://www.naver.com/WebJSP/);
