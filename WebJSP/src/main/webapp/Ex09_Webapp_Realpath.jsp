...
<%
	...
	String realcontextpath = application.getRealPath(request.getContextPath());  ///WebJsp >> 실제 배포 소스
	out.print("contextpath 통한 실 경로 : " + realcontextpath + "<br>");
	// C:\KOSA_IT\Web(Back)\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\WebJSP
	// 서버에 배포된 솟,
	
	String filepath = application.getRealPath(resourcepath);
	out.print("real path : " + filepath + "<br>");
	// 실 배포 경로
	//realpath : C:\KOSA_IT\Web(Back)\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
	
	//개발 소스 경로
	//		C:\KOSA_IT\Web(Back)\Labs\WebJSP\Ex09_Webapp_Realpath\download\note.txt
	
	/*
		URL : http://192.168.0.84:8090/WebJSP/Ex09_Webapp_Realpath.jsp
